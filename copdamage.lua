Hooks:PreHook(CopDamage, "_on_damage_received", "RR_on_damage_received", function(self, damage_info)
	...
	if Network:is_server() and damage_info.result.type == "death" and alive(attacker_unit) and attacker_unit:base() then -- in case this gets run on clients, don't do anything
